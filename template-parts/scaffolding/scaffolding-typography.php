...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'easy-journal' ); ?>">
		<?php esc_html_e( 'Typography', 'easy-journal' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>Easy Journal</del>',
			'output'      => '<p>We use <del>Easy Journal</del> wd_s to build themes.</p>',
		]
	);
