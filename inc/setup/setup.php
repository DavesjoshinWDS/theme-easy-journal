...
function setup() {
	 ...
	 * references of wd_s
	 */
	load_theme_textdomain( 'easy-journal', get_template_directory() . '/build/languages' );
	...
	register_nav_menus(
		[
			'primary' => esc_html__( 'Primary Menu', 'easy-journal' ),
			'footer'  => esc_html__( 'Footer Menu', 'easy-journal' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'easy-journal' ),
		]
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'easy_journal_custom_background_args',
			[
	...
	add_theme_support(
		...
		[
			[
				'name' => __( 'Small', 'easy-journal' ),
				'size' => 12,
				'slug' => 'small',
			],
			[
				'name' => __( 'Normal', 'easy-journal' ),
				'size' => 16,
				'slug' => 'normal',
			],
			[
				'name' => __( 'Large', 'easy-journal' ),
				'size' => 36,
				'slug' => 'large',
			],
			[
				'name' => __( 'Huge', 'easy-journal' ),
				'size' => 50,
				'slug' => 'huge',
			],
		]
