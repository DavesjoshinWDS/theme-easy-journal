...
function customize_scripts() {
	wp_enqueue_script( 'easy-journal-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
...
function selective_refresh_support( $wp_customize ) {
	...
	$settings = [
		...
		'easy_journal_copyright_text' => '.site-info',
	];
