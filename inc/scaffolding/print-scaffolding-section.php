		...
		<div class="tab">
			...
			<div class="scaffolding-document-content tab-content">
				...
				<?php if ( $args['description'] ) : ?>
					<p><strong><?php esc_html_e( 'Description', 'easy-journal' ); ?>:</strong></p>
					<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
				<?php endif; ?>

				<?php if ( $args['parameters'] ) : ?>
					<p><strong><?php esc_html_e( 'Parameters', 'easy-journal' ); ?>:</strong></p>
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'easy-journal' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'easy-journal' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'easy-journal' ); ?>:</strong></p>
